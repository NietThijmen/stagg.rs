...
export const derivedSchemas: string[] = [
...
export async function initializeDerivedTables(client: ClickHouseClient): Promise<void> {
  // ClickHouse's HTTP interface rejects multi-statement requests, so run each
